...
//    }
    ...
    public void editExec() throws Exception{
        ...
        try {
            ...
            System.out.print("New IC/PassportNumber: ");
    ...
    private void generateReport() throws Exception {
        System.out.println("\n==============REPORT GENERATION================");
        System.out.println("Report Type Choice: ");
        System.out.println("1. Item Name");
        System.out.println("2. Brand");
        System.out.println("3. Category");
        System.out.println("4. Date Added");
        ...
        switch(ch){
            case 1:
                ...
                data = x.generateReport(itemName, "item");
                
                break;
            case 2:
                System.out.print("Brand: ");
                String brand = input.nextLine();
                data = x.generateReport(brand, "brand");
                break;
            case 3:
                System.out.print("Category: ");
                String category = input.nextLine();
                data = x.generateReport(category, "category");
                break;
            case 4:
                System.out.print("Year/Month/Date[follow the syntax]: ");
                String date = input.nextLine();
                data = x.generateReport(date, "date");
        ...
        if(data.isEmpty()){
            ...
            PdfWriter.getInstance(document, new FileOutputStream("Report_"+unixTime+".pdf"));
